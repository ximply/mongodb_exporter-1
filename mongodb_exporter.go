...
var (
	...
	listenAddressF = flag.String("unix-sock", "/dev/shm/mongodb_exporter.sock", "Address to listen on for unix sock access and telemetry.")
...
func startWebServer() {
	...
	listener, err := net.Listen("unix", *listenAddressF)
	if err != nil {
		panic(err)
	}
